...
async function vizualizarInformacoesGlobais() {
    ...
    paragrafo.innerHTML='você sabia que o mundo tem ${dados.total_pessoas_mundo} de pessoas e que aproximadamente ${dados.tptal_pessoas_conectadas} estão conectadas em alguma rede social e passam em media ${daddos.tempo_medio}horas conectadas.'
